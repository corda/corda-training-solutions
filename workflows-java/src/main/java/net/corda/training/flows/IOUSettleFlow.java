...
public class IOUSettleFlow {
    ...
    public static class InitiatorFlow extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            // 3. Check the party running this flows is the borrower.
            ...
            // 8. Add the command and the input states to the transaction using the TransactionBuilder.
            tb.addCommand(command);
            tb.addInputState(inputStateAndRefToSettle);

            // 9. Add an IOU output states if the IOU in question that has not been fully settled.
