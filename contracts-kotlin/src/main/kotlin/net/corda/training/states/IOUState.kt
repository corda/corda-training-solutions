...
/**
 * This is where you'll add the definition of your states object. Look at the unit tests in [IOUStateTests] for
...
data class IOUState(val amount: Amount<Currency>,
    ...
    /**
     *  This property holds a list of the nodes which can "use" this states in a valid transaction. In this case, the
